...
window.addEventListener('scroll', function() {
    ...
    if (window.innerWidth > 500){
        ...
        } else if (547 < scrollPosition && scrollPosition <= 1557) {
            document.body.style.backgroundColor = '#fef6ec';
        } else if (1557 < scrollPosition && scrollPosition <= 4266) {
        ...
        if (scrollPosition <= 309) {
            document.body.style.backgroundColor = '#fef6ec';
        } else if (309 < scrollPosition && scrollPosition <= 1230) {
            document.body.style.backgroundColor = '#ede0d4';
        } else if (1230 < scrollPosition && scrollPosition <= 3200) {
            document.body.style.backgroundColor = '#472d30';
        } else {
            document.body.style.backgroundColor = '#fef6ec';
        }
